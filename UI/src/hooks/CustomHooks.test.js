...
describe('Validating API data', () => {
    it('Verify albums api return data', done => {
        ...
        MockAPI("http://jsonplaceholder.typicode.com/albums").then(response => {
    ...
    it('Verify users api return data', done => {
        ...
        MockAPI('http://jsonplaceholder.typicode.com/users').then(response => {
            expect(response).toEqual(data);
            done();
        });
    });     
    ...
    it('Verify Photo list by id api return data', done => {
        ...
        MockAPI("http://jsonplaceholder.typicode.com/photos" + "/1").then(response => {
            expect(response).toEqual(data);
            done();
        });
    });
    ...
    it('Verify album name id api return data', done => {
        ...
        MockAPI("http://jsonplaceholder.typicode.com/albums" + "/1").then(response => {
            expect(response).toEqual(data);
            done();
        });
    });    
